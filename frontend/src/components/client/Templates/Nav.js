    ...
    <div className='container-fluid'>
      <nav>
        <div className='row py-4 px-5 align-items-center'>
          ...
          <div className="mobile-nav-button d-md-block d-sm-block d-xs-block d-lg-none" onClick={handleClick}>
          ...
          <nav className={`mobile-menu ${isActive ? 'mobile-menu--open d-md-block d-sm-block d-xs-block' : ''}`}>
            <ul className='list-unstyled'>
              <li className='mr-1 font-size-48 active'>
                <Link className='d-inline-block active' to="/admin/posts">Accueil</Link>
              </li>
              <li className='mr-1 font-size-48'>
                <Link className="d-inline-block" to="/admin/posts">Services</Link>
              </li>
              <li className='mr-1 font-size-48'>
                <Link className="d-inline-block" to="/admin/posts">L'agence</Link>
              </li>
              <li className='font-size-48'>
                <Link className="d-inline-block" to="/admin/posts">Devis</Link>
              </li>

              <li className='mt-5 font-size-48'>
                <Link className="d-inline-block" to="/admin/posts">Contact</Link>
              </li>
              <li className='mt-5 text-center font-size-28'>
                <div className='client-place-burger d-inline-block'><Link to="/admin">Espace client</Link></div>
              </li>
            </ul>
          </nav>
