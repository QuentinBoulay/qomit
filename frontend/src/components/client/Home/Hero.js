  ...
  return (
    <>
      <div className="hero text-center">
        <h1>
          <span>Qomit</span>, l’agence qui vous accompagne dans le digital
        </h1>
        <div className="loop-container">
          ...
          >
            <path
              d="M1 33C6.92683 22.1174 16.5854 0.483543 7.80488 1.00942C2.36098 9.42338 13 25.8423 19 33"
              stroke="#5959EB"
            />
          </svg>
          <a href="/devis">
        ...
        <div className="loop-container">
          <svg
            className="loop-2 position-absolute"
            width="150"
            height="420"
            viewBox="0 0 150 420"
            fill="none"
        ...
        <div className="loop-container">
          <svg
            className="loop-3 position-absolute"
            width="395"
            height="501"
            viewBox="0 0 395 501"
            fill="none"
          ...
          >
            <path
              d="M167.036 1C9.5359 171 -193.864 553.9 394.536 493.5"
              stroke="#5959EB"
            />
          </svg>
        </div>
